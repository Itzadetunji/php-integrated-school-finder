<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="admin-sidebar">
						<div class="admin-user-item for-employer">
							...
							<p class="user-role" style="text-transform: capitalize;"> School</p>
						</div>

						<div class="admin-user-action text-center">
							<a href="post-job" class="btn btn-primary btn-sm btn-inverse">Post an Entrance</a>
						</div>
						...
						<ul class="admin-user-menu clearfix" style="list-style: none;">
							...
							<li <?php if( $user_panel_nav == 'posted-jobs') { echo 'class="active"'; } else {} ?>>
								<a href="posted-jobs"><i class="fa fa-bookmark"></i> Posted Entrances</a>
							</li>
							<li>
