...
<?php $head_title = 'Posted Entrances | School | BS'; ?>
						...
						<?php
							...
							if ($count_if_post_exist_res > 0) {
										...
										<a href="#" style="color: initial;"><figure class="card card-product">
											...
											<figcaption class="info-wrap">
												...
												<div class="rating-wrap">
													<div class="label-rating">State/City: <?php echo $row_post_info['job_city_town']; ?></div>
												</div>
												<div class="rating-wrap">
								...
								<div class="admin-empty-dashboard">
									...
									<h4>You have not posted any entrance yet!</h4>
									<a href="post-job.php" class="btn btn-primary">Post an entrance</a>
								</div>
							<?php }
						?>
					</div>
