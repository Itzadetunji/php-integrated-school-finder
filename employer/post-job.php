...
<?php $head_title = 'Post An Entrance | School | BS'; ?>
						...
						<form class="post-form-wrapper" action="php/post-job" method="POST">
							...
							<div class="col-sm-8 col-md-8">
								<div class="form-group">
									...
									<input name="job_title" required type="text" class="form-control" placeholder="Enter entrance title">
								</div>
							</div>
							 ...
							 <div class="col-sm-8 col-md-8">
								<div class="form-group">
									...
									<input name="job_city_town" required type="text" class="form-control" placeholder="E.g Lagos - Ikeja">
								</div>
							</div> 
								...
								<div class="col-sm-6 col-md-6">
									<div class="form-group">
										...
										<select name="job_type" required class="form-control">
											<option value="">-Select school section type-</option>
							...
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									...
									<textarea name="job_description" required class="form-control" minlength="100" placeholder="Enter entrance description ..." style="height: 200px;"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									...
									<textarea name="job_requirements" required class="form-control"  placeholder="Enter entrance requirements ..." style="height: 200px;"></textarea>
								</div>
							</div>

							<div class="col-sm-12 mt-10">
								<button type="submit" class="btn btn-primary" name="post-job">Post Entrance</button>
