...
<?php $head_title = ''.$company_name.' | BS'; ?>
				...
				<div class="col-md-10">
					<div class="company-detail-wrapper">
						...
						<header class="section-heading heading-line text-center">
							<h4 class="title-section bg text-uppercase pl-3">Entrances Offered At <?php echo $company_name; ?></h4>
						</header>
						...
						<?php
							...
							if ($count_if_post_exist_res > 0) {
											...
											<div class="row">
												...
												<aside class="col-sm-3 border-left">
													<div class="action-wrap">
														<p class="alert alert-primary" style="text-transform: uppercase; color: black; background-color: <?php echo $backg; ?> ;"> <?php echo $row_post_info['job_type']; echo " entrance"; ?> </p>
														<br>
								...
								<div class="admin-empty">
									...
									<h4 style="text-transform: uppercase;"> Sorry No Entrance Have been Posted!!</h4>
								</div>
							<?php }
						?>
					</div>
