...
<?php $head_title = 'Sign Up | Best School'; ?>
			...
			<div class="row">
				<div class="card col-md-5">
					<header class="card-header">
						<h4 class="card-title text-center mt-2">Parent Form</h4>
					</header>
						...
						<form action="php/create-account" method="POST" name="frm1">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" required class="form-control" name="comp_city_town" placeholder="E.g Lagos -Ikeja">
								</div>
								<div class="form-group col-md-6">
							...
							<div class="form-group">
								<input required class="form-control" name="role" type="text" value="parent" hidden>
				...
				<div class="card col-md-5">
					<header class="card-header">
						<h4 class="card-title text-center mt-2">School Form</h4>
					</header>
					<article class="card-body">
						<form action="php/create-account" method="POST" name="frm2">
							<div class="form-group">
								<label>School's Name</label>
								<input type="text" required class="form-control" name="comp_name" placeholder="Enter school's name">
							</div>
							<div class="form-group">
								<label>School's Email Address</label>
								<input type="email" required class="form-control" name="email" placeholder="Enter school's email address">
							</div>
							<div class="form-group">
								<label>School Type</label>
								<input type="text" required class="form-control" name="comp_type" placeholder="Enter school type E.g Montessori, Comprehensive, high School">
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
									<label>State/City</label>
							...
							<div class="form-group">
								<input required class="form-control" name="role" type="text" value="school" hidden>
