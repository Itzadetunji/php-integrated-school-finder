...
<?php $head_title = 'Search | Best School'; ?>
					...
					<form action="search" class="search-wrap" method="GET">
						<div class="input-group w-100">
							...
							<select class="custom-select" name="cat">
								<option <?php if( $search_nav == 'CM') { echo 'selected'; } else {} ?> value="CM"> Schools </option>
						...
						if ($count_if_query_exist_res > 0) {
										...
										<div class="row">
											...
											<aside class="col-sm-3 border-left">
												<div class="action-wrap">
													...
													<br>
													<p><a href="view-job?view=<?php echo $row_search_code['job_id']; ?>" class="btn btn-primary"> VIEW THIS ENTRANCE </a></p>
													<p><a href="view-company?view=<?php echo $row_search_code['job_company']; ?>" class="btn btn-secondary"> View this school </a></p>
												</div>
											</aside>
										</div>
									</div>
							...
							<div class="col-md-12">
								<div class="admin-empty-dashboard" style="margin: 0px 0 0px;">
									...
									<h4 style="text-transform: uppercase;">Sorry No Entrance Result for <?php echo $s_key; ?></h4>
								</div>
							</div>
						<?php }
					} elseif ($s_cat == "CM") {
						...
						if ($count_if_query_exist_res > 0) {
							...
							<div class="col-md-12">
								<div class="admin-empty-dashboard" style="margin: 0px 0 0px;">
									...
									<h4 style="text-transform: uppercase;">Sorry No School Result for <?php echo $s_key; ?></h4>
								</div>
							</div>
						<?php }
					} elseif ($s_cat == "EM") {
