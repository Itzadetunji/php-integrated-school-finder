			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar1">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item"><a <?php if( $page_nav == 'home') { echo 'style="color: white;"'; } else {} ?> class="nav-link" href="index.php">Home</a></li>
						<!-- <li class="nav-item"><a <?php if( $page_nav == 'job') { echo 'style="color: white;"'; } else {} ?> class="nav-link" href="job_list">Jobs</a></li> -->
						<li class="nav-item"><a <?php if( $page_nav == 'employers') { echo 'style="color: white;"'; } else {} ?> class="nav-link" href="employers">Schools</a></li>
						<!-- <li class="nav-item"><a <?php if( $page_nav == 'employees') { echo 'style="color: white;"'; } else {} ?> class="nav-link" href="employees">Employees</a></li> -->
						<li class="nav-item"><a <?php if( $page_nav == 'support') { echo 'style="color: white;"'; } else {} ?> class="nav-link" href="#">Support</a></li>
						<?php
							if ($user_online == true) {
								?>
