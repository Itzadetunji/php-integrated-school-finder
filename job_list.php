...
<?php $head_title = 'Entrance List | BS'; ?>
					...
					<?php
						...
						if ($count_if_post_exist_res > 0) {
										...
										<div class="row">
											...
											<aside class="col-sm-3 border-left">
												<div class="action-wrap">
													<p class="alert alert-primary" style="text-transform: uppercase; color: black; background-color: <?php echo $backg; ?> ;"> <?php echo $row_post_info['job_type']; echo " entracnce"; ?> </p>
													<br>
													<p><a href="view-job?view=<?php echo $row_post_info['job_id']; ?>" class="btn btn-primary"> VIEW THIS ENTRANCE </a></p>
													<p><a href="view-company?view=<?php echo $row_post_info['job_company']; ?>" class="btn btn-secondary"> View this school </a></p>
												</div>
											</aside>
										</div>
									</div>
							...
							<div class="admin-empty-dashboard" style="margin: 0px 0 0px;">
								...
								<h4 style="text-transform: uppercase;">Sorry No Entrances Available For Now</h4>
							</div>
						<?php }
					?>
				</main>
