...
<?php $head_title = 'Applied Entrances | Parent | BS'; ?>
							...
							<?php
								...
								if ($count_applications_res > 0) {
									...
									while ($row_application_info = mysqli_fetch_array($run_application_info)){
										...
										if ($count_if_job_exist_res > 0) {
														...
														<div class="row">
															...
															<article class="col-sm-6">
																...
																<ul class="list-icon row text-center">
																	<li class="col-md-12"><a><i class="icon fa fa-calendar"></i>Application Date: <span> <b><i><?php echo $application_date; ?></i></b></span></a></li>
																</ul>
															</article>
															<aside class="col-sm-3 border-left">
																<div class="action-wrap">
																	<p class="alert alert-primary" style="text-transform: uppercase; color: black; background-color: <?php echo $backg; ?> ;"> <?php echo $row_job_info['job_type']; echo " entrance"; ?> </p>
																	<br>
																	<p><a href="../view-job?view=<?php echo $row_job_info['job_id']; ?>" class="btn btn-primary"> VIEW THIS ENTRANCE </a></p>
																	<p><a href="../view-company?view=<?php echo $row_job_info['job_company']; ?>" class="btn btn-secondary"> View This School </a></p>
																</div>
															</aside>
														</div>
													</div>
											...
											<div class="admin-empty">
												...
												<h4 style="text-transform: uppercase;">Sorry!! This job has been deleted by its school</h4>
											</div>
										<?php }
									...
									<div class="admin-empty-dashboard">
										...
										<h4>You have not applied for any entrance!</h4>
										<a href="../job_list" class="btn btn-primary">Browse Entrances</a>
									</div>
								<?php }
							?>
						</main>
