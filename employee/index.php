...
<?php $head_title = 'My Profile | Parent | BS'; ?>
							...
							<div class="row gap-20">
								...
								<div class="col-sm-6 col-md-6">
									<div class="form-group">
										...
										<input name="city_town" required class="form-control" value="<?php echo $sess_city_town ?>" type="text" placeholder="E.g Lagos -Ikeja">
									</div>
								</div>
