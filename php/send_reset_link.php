			...
			while ($row_user_details = mysqli_fetch_array($run_user_details)){
				...
				if ($role = "employee") {
					...
					if ($insert_new_token_code) {
						...
						$message = "Hello!! <b>".$fname."</b>, <br>Click <a href='".$link."'>HERE</a> to reset your <b>BS</b> Account password.";
						...
						if (mail( $email, $subject, $message_body, $header)) {
							...
							header("location:../forgot?r=Error while sending confirmation link to your email. Try again.&ty=danger");
						}
					} else {
