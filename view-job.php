					...
					<div class="job-detail-wrapper">
						...
						<div class="job-detail-header text-center">
							...
							<div class="meta-div clearfix mb-25">
								...
								<span class="badge-type" style="text-transform: uppercase; background-color: <?php echo $backg; ?> ;"> <?php echo $job_type; ?> student</span>
							</div>
								...
								if ($jobexpired == true) {
									...
									if ($sess_role == "employee") {
										...
										if ($count_if_application_exist_res > 0) {
											...
											echo '<button class="btn btn-primary disabled btn-lg" style="text-transform: uppercase;"><i class="fa fa-lock"></i> You have already applied for this entrance</button>';
										} else {

											echo '<a href="php/apply?job='.$job_id.'&applicant='.$_SESSION['member_no'].'" '; ?> onclick = "return confirm('Are you sure you want to apply for this entrance ? YOU CAN NOT UNDO!!!')" <?php echo 'class="btn btn-primary btn-lg" type="submit" style="text-transform: uppercase;"><i class="fa fa-edit"></i> Apply for this entrance</a>';
										}
										
									} else {
										echo '<button class="btn btn-primary disabled btn-lg" style="text-transform: uppercase;"><i class="fa fa-lock"></i> Login as a parent to apply</button>';
									}
								}
							} else {
								echo '<button class="btn btn-primary disabled btn-lg" style="text-transform: uppercase;"><i class="fa fa-lock"></i> Login to apply this entrance</button>';	
							}
						?>
						...
						<section class="section-content bg padding-y">
							<div class="container">
								...
								<header class="section-heading heading-line text-center">
									<h4 class="title-section bg text-uppercase pl-3">Similar Entrances</h4>
								</header>
										...
										<?php
											...
											if ($count_if_post_exist_res > 0) {
															...
															<div class="row">
																...
																<aside class="col-sm-3 border-left">
																	<div class="action-wrap">
																		<p class="alert alert-primary" style="text-transform: uppercase; color: black; background-color: <?php echo $backg; ?> ;"> <?php echo $row_post_info['job_type']; echo " entracne"; ?> </p>
																		<br>
												...
												<div class="admin-empty">
													...
													<h4 style="text-transform: uppercase;">Sorry No Entrance Similar to This</h4>
												</div>
											<?php }
										?>
									</main>
