...
<?php $head_title = 'Best Schools | Entrance Portal'; ?>
...
<body class="relative" data-spy="scroll" data-target=".navbar-landing">
		...
		<div class="container d-flex flex-column" style="min-height:80vh;">
			...
			<div class="row mt-auto">
				<div class="col-lg-8 col-sm-12 text-center mx-auto">
					<h1 class="display-4 mb-3">Best School Finder</h1>
					<p class="lead mb-5">...THE NO.1 SCHOOL PORTAL TO GET A SCHOOL <b><i>FAST</i></b></p>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-9 col-md-8 col-sm-12 mx-auto text-center">
						...
						<div class="form-row mb-5">
							...
							<div class="col-lg-3 col-sm-12 form-group">
								<select class="custom-select form-control-lg" name="cat">
									<option <?php if( $search_nav == 'CM') { echo 'selected'; } else {} ?> value="SCH"> Schools </option>
									<option> Summer School(NA) </option>
								</select>
							</div>
							<div class="col-lg-3 col-sm-12 form-group">
					...
					<p class="small">YOU COULD FOLLOW US ON OUR SOCIAL MEDIA PLATFORMS FOR NEW AND LASTEST SCHOOL OFFERS</p>
	...
	<section id="features" class="section-features bg2 padding-y-lg">
		<div class="container">
				...
				<aside class="col-sm-4">
					<figure class="itembox text-center">
						...
						<figcaption class="text-wrap">
							<h4 class="title">Search for a School</h4>	
						</figcaption>
					</figure>
				</aside>
				<aside class="col-sm-4">
					<figure class="itembox text-center">
						...
						<figcaption class="text-wrap">
						<h4 class="title">Apply for an Entrance</h4>
						</figcaption>
					</figure>
				</aside>
				<aside class="col-sm-4">
					<figure class="itembox text-center">
						...
						<figcaption class="text-wrap">
						<h4 class="title">Start Schooling</h4>
						</figcaption>
					</figure>
				</aside>
			</div>
			...
			<p class="text-center">
				<br>
				<a href="sign-up.php" class="btn btn-warning">Register</a>
			</p>
		</div>
	</section>
	...
	<section class="section-content padding-y-sm bg">
		<div class="container">
			...
			<header class="section-heading heading-line text-center">
				<h4 class="title-section bg pl-3">Random Entrances</h4>
			</header>
					...
					<?php
						...
						if ($count_if_post_exist_res > 0) {
										...
										<div class="row">
											...
											<aside class="col-sm-3 border-left">
												<div class="action-wrap">
													<p class="alert alert-primary" style="text-transform: uppercase; color: black; background-color: <?php echo $backg; ?> ;"> <?php echo $row_post_info['job_type']; echo " school entrance"; ?> </p>
													<br>
													<p><a href="view-job?view=<?php echo $row_post_info['job_id']; ?>" class="btn btn-primary"> VIEW THIS ENTRANCE </a></p>
													<p><a href="view-company?view=<?php echo $row_post_info['job_company']; ?>" class="btn btn-secondary"> View School </a></p>
												</div>
											</aside>
										</div>
									</div>
							...
							<div class="admin-empty-dashboard" style="margin: 0px 0 0px;">
								...
								<h4 style="text-transform: uppercase;">Sorry No School(s) Available For Now</h4>
							</div>
						<?php }
					?>
				</main>
        ...
        <div class="row">
          <div class="col">
            <div class="testimonial">
              <img src="p1.png" alt="">
              <div class="name">PARENT'S NAME</div>
              <div class="stars">
              </div>
	...
	<section class="section-content padding-y-sm bg">
		<div class="container">
			...
			<header class="section-heading heading-line text-center">
				<h4 class="title-section bg pl-3">Random Schools</h4>
			</header>
			...
			<div class="row">
				<?php
					...
					if ($count_if_employer_exist_res > 0) {
						$get_employer_info = "SELECT * FROM `tbl_users` WHERE role = 'employer' ORDER BY RAND() LIMIT 4";
									...
									<figcaption class="info-wrap">
										...
										<div class="action-wrap">
											...
											<div class="price-wrap h6">
												<span class="price-new"><?php echo $count_active_post_res; ?> Entrance Post(s)</span>
											</div>
						...
						<div class="col-md-12">
							<div class="admin-empty-dashboard" style="margin: 0px 0 0px;">
								...
								<h4 style="text-transform: uppercase;">Sorry No School For Now</h4>
							</div>
						</div>
					<?php }
				?>
